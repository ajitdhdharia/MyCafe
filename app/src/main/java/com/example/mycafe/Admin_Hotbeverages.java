 ...
 */
public class Admin_Hotbeverages extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_admin__hotbeverages, container, false);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean check  = db.insertUploadData("Hot Beverages",ed_itemname.getText().toString(), imageinbtye,ed_cost.getText().toString(),"Active","0");
