package com.example.mycafe.ui.HotBeverages;
...
public class HotBeveragesFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.hotbeverages, container, false);
        recyclerView= view.findViewById(R.id.recycler);
        databaseHandler = new Db_frall(faltu_context.context);
        //  rating=view.findViewById(R.id.rating);
        rvAdapter =new ShowItemsAdapter(databaseHandler.getAllImagesData("Hot Beverages","Active") );
