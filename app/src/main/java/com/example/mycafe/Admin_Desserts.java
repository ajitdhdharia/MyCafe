 ...
 */
public class Admin_Desserts extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_admin__desserts, container, false);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean check  = db.insertUploadData("Desserts",ed_itemname.getText().toString(), imageinbtye,ed_cost.getText().toString(),"Active","0");
